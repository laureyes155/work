...
df1 = clean_dataset_esp2(pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2019_2025.csv', usecols=[2], na_values=[ 'N/E']))
print('-------')
print(df1.values)
print('-------')
df2 = clean_dataset_esp2( pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2019_2021.csv', usecols=[2], na_values=['N/E']))
print('-------')
print(df2.values)
print('-------')
df3 = clean_dataset_esp2( pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2022_2025.csv', usecols=[2], na_values=[ 'N/E']))
