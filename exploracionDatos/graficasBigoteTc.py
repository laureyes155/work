...
from funciones import clean_dataset

# Leer solo la columna deseada para ahorrar memoria
df1 = (pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2019_2025.csv', usecols=[3], na_values=[ 'N/E']))
print('-------')
print(df1.values)
print('-------')
df2 = ( pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2019_2021.csv', usecols=[3], na_values=['N/E']))
print('-------')
print(df2.values)
print('-------')
df3 = ( pd.read_csv('../datos/Spei_CodiVSTipoDeCambio_2022_2025.csv', usecols=[3], na_values=[ 'N/E']))
