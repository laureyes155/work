...
# load the dataset
dataframe = read_csv('../datos/montoSpeiVSTipoDeCambio.csv', usecols=[1, 2], engine='python')
...
for i in range(0,  len(dataset0)):
    if dataset0[i][0] == 'N/E' or dataset0[i][1] == 'N/E' or dataset0[i][0] == 'nan' or dataset0[i][1] == 'nan':
